...
## OUTPUT:
![image](https://github.com/user-attachments/assets/35d5499a-0513-4b28-9208-51fa9a0d36a1)


## RESULT:
Thus the program has been executed by unrolling by 8 and unrolling by 16. It is observed that 16 has executed with less elapsed time than 8 blocks with blocks 0.050811,000339.
